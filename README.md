...
#### Full System:
![Show User Card](assets/0Web-1And2.png)

#### StartUp/Login/SignUp:
| StartUP Pages | Login/SignUP |
|---------------|--------------|
| ![](assets/1Mobile-StartApp-Light.png) | ![](assets/2Mobile-Login-Dark.png) | 

#### Teacher Dashboard:
![Teacher-Dashboard](assets/3Mobile-TeacherDashboard-Dark.png)

#### Course Management & Creation:
| Course Creation | Course Management |
|-----------------|-------------------|
| ![](assets/6Mobile-CourseCreation-Light.png) | ![](assets/4Mobile-CourseManagement-Light.png) | 

#### Quality Education:
![Quality-Education](assets/04Web3.png)

#### Sessions & Quizzes:
![Sessions & Quizzes](assets/5Mobile-SessionsAndQuizzes-Dark.png)
